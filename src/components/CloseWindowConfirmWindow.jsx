...
export default function CloseWindowConfirmWindow({onClose}) {
    return (
        <div id="closeWindow" className="bg-backgroundLight w-[400px] h-[326px] rounded-[25px] fixed z-40 drop-shadow-button left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]">
            ...
            <button className="font-poppins text-ft text-highlighted-textcolor absolute ml-[41px] bottom-[34px]" onClick={onClose}>Nein, weiter machen!</button>
